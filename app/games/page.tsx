...
const games: LobbyGame[] = [
  ...
  { name: "Neon Draw", studio: "PINKKIS + JARED KJAR FOUNDATION", tag: "99.54% RTP", image: "/game-art/video-poker.webp", href: "/games/video-poker", tone: "purple", categories: ["Originals", "Table games", "High limit"] },
